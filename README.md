...
- ✅ **Типизированная схема** - `_datacode_schema` + `_datacode_version` с Datacode-типами колонок и declared SQLite-типами (`DATE`/`DATETIME`/`INTEGER` nanos для duration и т.д.)
