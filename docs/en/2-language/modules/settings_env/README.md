...
- **English:** [examples/en/11-settings-env/](../../../examples/en/11-settings-env/)
- **Russian:** [examples/ru/11-settings_env/](../../../examples/ru/11-settings_env/)
...
```bash
datacode --bin datacode examples/en/11-settings-env/01-basic-usage.dc
```
