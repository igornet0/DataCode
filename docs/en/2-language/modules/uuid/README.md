...
- **English:** [examples/en/12-uuid/](../../../examples/en/12-uuid/)
- **Russian:** [examples/ru/12-uuid/](../../../examples/ru/12-uuid/)
...
```bash
datacode --bin datacode examples/en/12-uuid/01-basic-usage.dc
```
