...
**Russian version:** [модуль system (русский)](../../ru/system-lib/README.md)
...
| `system.process` | Shell command execution (`exec`) |
...
| `gpu_count()` | Currently `0` (stub) |
| `gpu_info()` | Empty array (stub; contract may evolve) |
...
- Built-in modules and imports: [Modules and Imports](../modules_and_imports.md).
