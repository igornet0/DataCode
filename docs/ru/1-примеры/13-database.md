# Примеры: 13 — database_engine

Модуль `database_engine`: SQL-движок, подключения, запросы.  
Папка: [`examples/ru/13-database/`](../../../examples/ru/13-database/)
...
→ [08-создание-модели-данных](./08-создание-модели-данных.md) · [14-модули](./14-модули.md)
