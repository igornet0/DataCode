...
**Пример:**
```datacode
img = plot.image("путь/к/изображению.png")
if img != null {
...
**Пример:**
```datacode
окно = plot.window(800, 600, "Мое окно")
if окно != null {
...
**Пример:**
```datacode
окно = plot.window(800, 600, "Просмотр")
изображение = plot.image("image.png")
if окно != null and изображение != null {
...
**Пример:**
```datacode
окно = plot.window(800, 600, "Ожидание")
plot.wait(окно)
print("Окно закрыто")
...
# Создание окна
окно = plot.window(1024, 768, "Просмотр изображения")
if окно == null {
...
- [Встроенные функции](../../функции/README.md)
