...
**Пример:**
```datacode
cfg = Settings.config(env_prefix="APP__", extra="ignore")
env = load_env("with_prefix.env", [], cfg)
...
- **Русский:** [examples/ru/11-settings_env/](../../../../../examples/ru/11-settings_env/)
