...
**Запуск**:
```bash
datacode --bin datacode examples/ru/11-settings_env/01-базовое_использование.dc
```
...
**Запуск**:
```bash
datacode --bin datacode examples/ru/11-settings_env/02-типы_и_приведение.dc
```
...
**Запуск**:
```bash
datacode --bin datacode examples/ru/11-settings_env/03-префикс_и_config.dc
```
...
**Запуск**:
```bash
datacode --bin datacode examples/ru/11-settings_env/04-field.dc
```
...
**Запуск**:
```bash
datacode --bin datacode examples/ru/11-settings_env/05-класс_config.dc
```
...
**Запуск**:
```bash
datacode --bin datacode examples/ru/11-settings_env/06-практический_пример.dc
```
